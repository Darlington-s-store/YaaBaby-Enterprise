...
const stats = [
  { label: "Orders", value: myOrders.length, icon: Package, to: "/account/orders" },
  { label: "Wishlist", value: myWishlist.length, icon: Heart, to: "/account/wishlist" },
...
const Overview = () => {
  ...
  return (
    <div className="space-y-10">
      <section className="relative overflow-hidden rounded-3xl bg-emerald-gold p-6 lg:p-8 text-primary-foreground">
        <div className="relative z-10 max-w-xl">
          <p className="text-xs uppercase tracking-widest opacity-80 mb-2">Welcome back</p>
          <h2 className="font-display text-2xl lg:text-3xl font-bold mb-2">Your edit awaits, {user.name.split(" ")[0]}.</h2>
          <p className="opacity-85 text-sm mb-5">New arrivals from Maison Yaa, Atlas and Aurix — curated just for you.</p>
