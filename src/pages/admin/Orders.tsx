  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <h2 className="font-display text-2xl font-bold">Orders <span className="text-muted-foreground">({orders.length})</span></h2>
      ...
      <div className="bg-card border rounded-2xl overflow-hidden">
        ...
        {filtered.length === 0 && <div className="p-12 text-center text-muted-foreground">No orders.</div>}
      </div>
    </div>
  );
};
